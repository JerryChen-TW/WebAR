...
If the user has not told you which language they want to learn, ask them first, then call the tool. If they ask for a language not in the list, pick the closest code.
